    ...
    <div>
        <div class="fott">
            ...
            <div class="services">
                ...
                <h3><b>Services</b></h3>
                <ul v-for="(lista, index) in services" :key="index">
                    <li>{{ lista }}</li>
                </ul>
            </div>
            <div class="resources">
                <h3><b> Resouces</b></h3>
                <ul v-for="(lista, index) in resources" :key="index">
                    <li>{{ lista }}</li>
                </ul>
            </div>
            <div class="company">
                <h3><b> Company</b></h3>
                <ul v-for="(lista, index) in company" :key="index">
                    <li>{{ lista }}</li>
                </ul>
            </div>
        </div>
...
export default {
    name: 'FooterProject',
    props: ['services', 'resources', 'company']
